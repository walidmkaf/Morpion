...
public class MultijoueurOfflineFonctions
{
    /*
    *
    ...
    */
    ...
    public MultijoueurOfflineFonctions()
    {
    }
    ...
    public void FonctionPrincipale(ObjetsJeu tableau, int id, Boutons lesBoutons)
    {
        tableau.setValeurTableau(id, tableau.getJoueur());
    ...
    */
    ...
    private void verifVictoire(ObjetsJeu tableau, int i) {
		...
		*/
        ...
        {
            if (tableau.getValeurTableau(0, 0) == tableau.getValeurTableau(1, 1) && tableau.getValeurTableau(1, 1) == tableau.getValeurTableau(2, 2))
                finDeJeu = true;
            else if (tableau.getValeurTableau(2, 0) == tableau.getValeurTableau(1, 1) && tableau.getValeurTableau(1, 1) == tableau.getValeurTableau(0, 2))
                finDeJeu = true;
        }

        if (tableau.getValeurTableau(ligne, 0) == tableau.getValeurTableau(ligne, 1) && tableau.getValeurTableau(ligne, 1)  == tableau.getValeurTableau(ligne, 2))
            finDeJeu = true;
        if (tableau.getValeurTableau (0, colonne) == tableau.getValeurTableau (1, colonne) && tableau.getValeurTableau(1, colonne) == tableau.getValeurTableau (2, colonne))
            finDeJeu = true;
